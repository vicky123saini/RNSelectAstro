...
export default class ContactUsScreen extends Component {
  ...
  componentDidMount = () => {
    ...
    .catch(()=> console.error("err contactUs getProfile"));
  };
  ...
  render() {
    ...
    <ScrollView style={{flex:1, backgroundColor:"#fff"}}>
      <View style={{padding:30}}>
        <TouchableOpacity onPress={()=> Linking.openURL(`tel:+916307468674`)}>
            <Text style={[styles.label,{marginBottom:20}]}>Please Call <Text style={{color:"blue", textDecorationLine:"underline"}}>+916307468674</Text> for any support</Text>
        </TouchableOpacity>
